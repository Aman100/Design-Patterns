...
using namespace std;
/*
Another Way of Implementing Solution2
Instead of creating functions for each filter we will use lambdas.
*/
...
vector<Student*> studentVector=StudentFilter::applyFilter(students,[](Student *student) { return string("Ujjain")==student->getCity(); });
